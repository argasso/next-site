...
export const Hero: FC<Props> = ({ title, intro }) => (
  <div className=" text-white">
    <div className="container flex flex-wrap flex-col md:flex-row items-center">
      <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
        <h1 className="my-4 text-5xl leading-tight font-serif">
          <div className="uppercase w-full text-lg font-normal font-sans my-4">
            {title}
          </div>
          {intro}
        </h1>
        <a
          href="/boecker"
          className="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline"
        >
          Se alla våra böcker
        </a>
      </div>

      <div className="w-full md:w-3/5 p-12 md:p-12 lg:p-12 lg:max-w-xl">
        {/* <img className="w-full md:w-4/5 z-50" src="uploads/hero.png" /> */}
        <svg
          className="m-auto"
